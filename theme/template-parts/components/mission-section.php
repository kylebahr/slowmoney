<!-- Main Container -->
<div class="px-6 mx-auto -mt-12 max-w-7xl sm:mt-0 lg:px-8 xl:-mt-8">
	<!-- Content Section -->
	<div class="max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
		<!-- Title -->
		<h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our vision, mission and impact.</h2>
		<!-- Content Block -->
