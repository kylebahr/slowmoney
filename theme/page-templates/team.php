...
<section class="px-6 mx-auto max-w-7xl lg:px-8">
    ...
    <!-- Main section -->
    <ul role="list" class="four-col-grid">
        <?php
        // Check if the 'team_members' row exists
        if (function_exists('have_rows') && have_rows('team_members')) :
            while (have_rows('team_members')) :
                ...
                <li x-data="{ open: false }">
                    ...
                    <h3 class="mt-6 text-lg font-extrabold leading-8 tracking-tight text-gray-900"><?= $name; ?></h3>
                    <p class="text-base leading-7 text-gray-600"><?= $role; ?></p>

                    <div class="mt-2">
                        <!-- Read Bio button -->
                        <div class="group flex items-center space-x-2.5 text-sm font-medium text-green-600 hover:text-green-900">
                            <!-- SVG Icon -->
